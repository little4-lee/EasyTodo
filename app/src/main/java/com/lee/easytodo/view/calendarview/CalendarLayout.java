...
public class CalendarLayout extends LinearLayout {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (dy > 0 && mContentView.getTranslationY() == 0 && y >= CalendarUtil
                        .dipToPx(getContext(), 98)) {
                    return false;
                }
    ...
    protected boolean isScrollTop() {
        if (mContentView instanceof CalendarLayout.CalendarScrollView) {
            return ((CalendarLayout.CalendarScrollView) mContentView).isScrollToTop();
        }
