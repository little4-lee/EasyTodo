...
public final class DefaultMonthView extends MonthView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mDelegate.mDragActionInteractor.setViewWidth(getMeasuredWidth());
    }
    ...
    protected void onDrawDropAbove(Canvas canvas, Calendar calendar, int x, int y) {
        // TODO: 2019-08-19 切换dragpaint
        mSelectedPaint.setColor(0x88000000);
        canvas.drawRect(x + mPadding, y + mPadding, x + mItemWidth - mPadding, y + mItemHeight - mPadding, mSelectedPaint);
//        canvas.drawCircle((float) x + (mItemWidth / 2), (float) y + (mItemHeight / 2), (mItemWidth-2*mPadding)/2, mSelectedPaint);
